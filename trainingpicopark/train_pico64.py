...
- Logs metrics to metrics.json for visualization
...
if __name__ == "__main__":
    ...
    # Initialize metrics logger (quiet, no extra output)
    ...
    for lvl in LEVELS:
        ...
        for local_iter in range(10000):  # up to 100 iters per level (adjust as needed)
            ...
            policy_loss, value_loss = ppo.update(ro, epochs=EPOCHS, batch_size=BATCH_SIZE)
